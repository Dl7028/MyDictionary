...
import com.example.mydictionary.db.NoteWordsAction;
import com.example.mydictionary.entity.Words;
import com.example.mydictionary.https.HttpCallBackListener;
import com.example.mydictionary.https.HttpUtil;
import com.example.mydictionary.util.ParseJSON;
import com.example.mydictionary.util.ParseXML;
import com.example.mydictionary.util.WordsHandler;

import java.io.InputStream;

import static com.example.mydictionary.db.WordsAction.db;
import static com.example.mydictionary.view.HistoryRecordsActivity.wordsAction;
...
public class TranslateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化控件
        searchWords_linerLayout =  findViewById(R.id.searchWords_linerLayout);
        searchWords_posA_layout =  findViewById(R.id.searchWords_posA_layout);
        searchWords_posE_layout = findViewById(R.id.searchWords_posE_layout);
        searchWords_fatherLayout =  findViewById(R.id.searchWords_fatherLayout);
        ...
        //初始化布局，控件变量
        searchWords_key = findViewById(R.id.searchWords_key);
        searchWords_psE =  findViewById(R.id.searchWords_psE);
        searchWords_psA =  findViewById(R.id.searchWords_psA);
        searchWords_posAcceptation =  findViewById(R.id.searchWords_posAcceptation);
        searchWords_sent =  findViewById(R.id.searchWords_sent);

        //收藏点击事件
        button_collect = findViewById(R.id.bt_collect);
